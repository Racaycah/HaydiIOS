...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Forms9Patch.Droid.ChoiceListener, Forms9Patch.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ChoiceListener.class, __md_methods);
	}


	public ChoiceListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ChoiceListener.class)
			mono.android.TypeManager.Activate ("Forms9Patch.Droid.ChoiceListener, Forms9Patch.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
