...
public class NativeGestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FormsGestures.Droid.NativeGestureListener, FormsGestures.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NativeGestureListener.class, __md_methods);
	}


	public NativeGestureListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == NativeGestureListener.class)
			mono.android.TypeManager.Activate ("FormsGestures.Droid.NativeGestureListener, FormsGestures.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
